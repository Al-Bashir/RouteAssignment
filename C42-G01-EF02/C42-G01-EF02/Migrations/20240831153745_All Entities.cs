    ...
    public partial class AllEntities : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AnyThing = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CouresName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Courses", x => x.AnyThing);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DName = table.Column<string>(type: "nvarchar(25)", maxLength: 25, nullable: false),
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_CourseInstructors_Instructores_InstructorId",
                table: "CourseInstructors",
                column: "InstructorId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Departments_Instructores_MangerId",
                table: "Departments",
                column: "MangerId",
                principalTable: "Instructores",
                principalColumn: "Id");
